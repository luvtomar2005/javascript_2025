...
//?   A "first-class function" means that functions can be treated as values, assigned to
//  variables, and passed around as arguments.
...
//* Interview Question:
//* ===================================
//! Write a program to perform mathematical operations using callback functions and two 
...
console.log(mathOperations(5,5,add));
console.log(mathOperations(9,5,sub));