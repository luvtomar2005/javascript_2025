// Local storage helps us to set the data in the key value pair

// Adding data in the local storage
localStorage.setItem("MyJsLearning", "addingData");

// Getting the data from the localStorage
console.log(localStorage.getItem("MyJsLearning")); // Output: "addingData"



// //todo Local Storage can only store strings, so when you want to store a complex data structure like an array or an object, you need
//  to convert it to a string using JSON.stringify:
